...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Svg Images'),
      centerTitle: true,
      ),
      body: Padding(
        ...
        child: ListView(
          children: [
            ...
            SvgPicture.asset(
             ...
             SizedBox(height: 20),
            // SVG STRING
            Text('SVG String images'),
            SvgPicture.string(svgString,
            width: 100,
            height: 100),
            // svg internet
            Text('SVG network images'),
            SvgPicture.network("https://www.svgrepo.com/show/2046/dog.svg",
